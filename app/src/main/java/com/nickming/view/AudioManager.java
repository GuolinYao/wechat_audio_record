...
public class AudioManager {
	...
	private int mMaxRecordeTime = 60;//最长录音时间 、秒
	...
	public void prepareAudio() {
		try {
			...
			mRecorder.setMaxDuration(mMaxRecordeTime * 1000);
	...
	public int getmMaxRecordeTime() {
		return mMaxRecordeTime;
	}

	public void setmMaxRecordeTime(int mMaxRecordeTime) {
		this.mMaxRecordeTime = mMaxRecordeTime;
	}
